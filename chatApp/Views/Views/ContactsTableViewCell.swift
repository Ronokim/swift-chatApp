...
class ContactsTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        icon.frame = CGRect(x: 5, y: 10, width: 50, height: 50)
        ...
        nameLabel.frame = CGRect(x: icon.frame.origin.x + icon.frame.size.width + 15, y: 10, width: self.bounds.width - 10, height: 25)
        ...
        msisdnLabel.frame = CGRect(x: icon.frame.origin.x + icon.frame.size.width + 15, y: nameLabel.frame.size.height + nameLabel.frame.origin.y + 5, width: self.bounds.width - 10, height: 25)
        ...
        msisdnLabel.font = UIFont.systemFont(ofSize: 13, weight: UIFont.Weight(rawValue: 0))
